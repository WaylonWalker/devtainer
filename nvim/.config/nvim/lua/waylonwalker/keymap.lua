...
set("n", "<leader>gR", "<cmd>Telescope lsp_references<cr>")
set("n", "<leader>gr", "<cmd>lua vim.lsp.buf.references()<cr>")
set("n", "<leader>gd", "<cmd>lua vim.lsp.buf.definition()<cr>")
set("n", "<leader>gD", "<cmd>Telescope lsp_definitions<cr>")
set("n", "<leader>gn", "<cmd>lua vim.lsp.buf.rename()<cr>")
set("n", "<leader>gh", "<cmd>lua vim.lsp.buf.hover()<cr>")
set("n", "<leader>gH", "<cmd>Lspsaga hover_doc<cr>")
set("n", "<leader>gl", "<cmd>lua Snacks.picker.git_log()<cr>")
set("n", "<leader>gL", "<cmd>lua Snacks.picker.git_log_line()<cr>")
set("n", "<leader>gF", "<cmd>lua Snacks.picker.git_log_file()<cr>")
set("n", "<leader>gb", "<cmd>lua Snacks.picker.git_branches()<cr>")
set("n", "<leader>gd", "<cmd>lua Snacks.picker.git_diff()<cr>")
set("n", "<leader>gf", "<cmd>lua Snacks.gitbrowse()<cr>")
set("n", "<leader>gB", "<cmd>lua Snacks.git.blame_line()<cr>")
set("n", "<leader>gs", "<cmd>lua Snacks.picker.git_status()<cr>")

...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	case "${OS}_${ARCH}" in
	"linux_arm64")
		URL="https://github.com/WaylonWalker/nvim-manager/releases/download/v0.2.1/nvim-manager-0.2.1-aarch64-unknown-linux-gnu.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_amd64")
		URL="https://github.com/WaylonWalker/nvim-manager/releases/download/v0.2.1/nvim-manager-0.2.1-x86_64-unknown-linux-gnu.tar.gz"
		FTYPE=".tar.gz"
		;;

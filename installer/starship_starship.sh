...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	case "${OS}_${ARCH}" in
	"darwin_arm64")
		URL="https://github.com/starship/starship/releases/download/v1.17.1/starship-aarch64-apple-darwin.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_arm64")
		URL="https://github.com/starship/starship/releases/download/v1.17.1/starship-aarch64-unknown-linux-musl.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_arm")
		URL="https://github.com/starship/starship/releases/download/v1.17.1/starship-arm-unknown-linux-musleabihf.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_amd64")
		URL="https://github.com/starship/starship/releases/download/v1.17.1/starship-i686-unknown-linux-musl.tar.gz"
		FTYPE=".tar.gz"
		;;
	"darwin_amd64")
		URL="https://github.com/starship/starship/releases/download/v1.17.1/starship-x86_64-apple-darwin.tar.gz"
		FTYPE=".tar.gz"
		;;
	"freebsd_amd64")
		URL="https://github.com/starship/starship/releases/download/v1.17.1/starship-x86_64-unknown-freebsd.tar.gz"
		FTYPE=".tar.gz"
		;;

...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	"darwin_arm64")
		...
		;;
	"linux_arm64")
		URL="https://github.com/starship/starship/releases/download/v1.19.0/starship-aarch64-unknown-linux-musl.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_arm")
		URL="https://github.com/starship/starship/releases/download/v1.19.0/starship-arm-unknown-linux-musleabihf.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_amd64")
	...
	"darwin_amd64")
		...
		;;
	"freebsd_amd64")
		URL="https://github.com/starship/starship/releases/download/v1.19.0/starship-x86_64-unknown-freebsd.tar.gz"
		FTYPE=".tar.gz"
		;;

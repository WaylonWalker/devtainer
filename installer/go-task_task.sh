...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	"darwin_arm64")
		...
		;;
	"freebsd_386")
		URL="https://github.com/go-task/task/releases/download/v3.44.0/task_freebsd_386.tar.gz"
		FTYPE=".tar.gz"
		;;
	"freebsd_amd64")
		URL="https://github.com/go-task/task/releases/download/v3.44.0/task_freebsd_amd64.tar.gz"
		FTYPE=".tar.gz"
		;;
	"freebsd_arm")
		URL="https://github.com/go-task/task/releases/download/v3.44.0/task_freebsd_arm.tar.gz"
		FTYPE=".tar.gz"
		;;
	"freebsd_arm64")
		URL="https://github.com/go-task/task/releases/download/v3.44.0/task_freebsd_arm64.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_386")
		URL="https://github.com/go-task/task/releases/download/v3.44.0/task_linux_386.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_amd64")

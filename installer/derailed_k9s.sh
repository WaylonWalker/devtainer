...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	"darwin_arm64")
		...
		;;
	"freebsd_amd64")
		URL="https://github.com/derailed/k9s/releases/download/v0.32.7/k9s_Freebsd_amd64.tar.gz"
		FTYPE=".tar.gz"
		;;
	"freebsd_arm64")
		URL="https://github.com/derailed/k9s/releases/download/v0.32.7/k9s_Freebsd_arm64.tar.gz"
		FTYPE=".tar.gz"
		;;
	"freebsd_arm")
		URL="https://github.com/derailed/k9s/releases/download/v0.32.7/k9s_Freebsd_armv7.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_amd64")
	...
	"linux_arm64")
		...
		;;
	"linux_arm")
		URL="https://github.com/derailed/k9s/releases/download/v0.32.7/k9s_Linux_armv7.tar.gz"
		FTYPE=".tar.gz"
		;;

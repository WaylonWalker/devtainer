...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	case "${OS}_${ARCH}" in
	"linux_arm64")
		URL="https://github.com/bootandy/dust/releases/download/v1.2.0/dust-v1.2.0-aarch64-unknown-linux-gnu.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_arm")
		...
		;;
	"linux_amd64")
		URL="https://github.com/bootandy/dust/releases/download/v1.2.0/dust-v1.2.0-i686-unknown-linux-gnu.tar.gz"
		FTYPE=".tar.gz"
		;;
	"darwin_amd64")
		URL="https://github.com/bootandy/dust/releases/download/v1.2.0/dust-v1.2.0-x86_64-apple-darwin.tar.gz"
		FTYPE=".tar.gz"
		;;

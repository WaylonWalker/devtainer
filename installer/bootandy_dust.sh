...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	case "${OS}_${ARCH}" in
	"linux_arm64")
		URL="https://github.com/bootandy/dust/releases/download/v1.1.1/dust-v1.1.1-aarch64-unknown-linux-gnu.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_arm")
		URL="https://github.com/bootandy/dust/releases/download/v1.1.1/dust-v1.1.1-arm-unknown-linux-gnueabihf.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_amd64")
		...
		;;
	"darwin_amd64")
		URL="https://github.com/bootandy/dust/releases/download/v1.1.1/dust-v1.1.1-x86_64-apple-darwin.tar.gz"
		FTYPE=".tar.gz"
		;;

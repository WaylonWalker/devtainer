...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	case "${OS}_${ARCH}" in
	"darwin_arm64")
		URL="https://github.com/atuinsh/atuin/releases/download/v18.5.0/atuin-aarch64-apple-darwin-update"
		FTYPE=".bin"
		;;
	"linux_arm64")
		URL="https://github.com/atuinsh/atuin/releases/download/v18.5.0/atuin-aarch64-unknown-linux-gnu-update"
		FTYPE=".bin"
		;;
	"darwin_amd64")
		URL="https://github.com/atuinsh/atuin/releases/download/v18.5.0/atuin-x86_64-apple-darwin-update"
		FTYPE=".bin"
		;;
	"linux_amd64")
		URL="https://github.com/atuinsh/atuin/releases/download/v18.5.0/atuin-x86_64-unknown-linux-gnu-update"
		FTYPE=".bin"
		;;

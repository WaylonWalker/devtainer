...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	case "${OS}_${ARCH}" in
	"darwin_amd64")
		URL="https://github.com/ollama/ollama/releases/download/v0.3.9/ollama-darwin"
		FTYPE=".bin"
		;;
	"linux_amd64")
		URL="https://github.com/ollama/ollama/releases/download/v0.3.9/ollama-linux-amd64-rocm.tgz"
		FTYPE=".tgz"
		;;
	"linux_arm64")

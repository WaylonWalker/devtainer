...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	"darwin_amd64")
		...
		;;
	"linux_amd64")
		URL="https://github.com/ollama/ollama/releases/download/v0.1.28/ollama-linux-amd64"
		FTYPE=".bin"
		;;
	"linux_arm64")
		URL="https://github.com/ollama/ollama/releases/download/v0.1.28/ollama-linux-arm64"
		FTYPE=".bin"
		;;

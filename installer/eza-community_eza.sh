...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	case "${OS}_${ARCH}" in
	"linux_arm64")
		URL="https://github.com/eza-community/eza/releases/download/v0.20.8/eza_aarch64-unknown-linux-gnu.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_arm")
		URL="https://github.com/eza-community/eza/releases/download/v0.20.8/eza_arm-unknown-linux-gnueabihf.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_amd64")

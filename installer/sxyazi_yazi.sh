...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	case "${OS}_${ARCH}" in
	"darwin_arm64")
		URL="https://github.com/sxyazi/yazi/releases/download/v25.2.11/yazi-aarch64-apple-darwin.zip"
		FTYPE=".zip"
		;;
	"linux_arm64")
		URL="https://github.com/sxyazi/yazi/releases/download/v25.2.11/yazi-aarch64-unknown-linux-gnu.zip"
		FTYPE=".zip"
		;;
	"linux_amd64")
		URL="https://github.com/sxyazi/yazi/releases/download/v25.2.11/yazi-i686-unknown-linux-gnu.zip"
		FTYPE=".zip"
		;;
	"darwin_amd64")
		URL="https://github.com/sxyazi/yazi/releases/download/v25.2.11/yazi-x86_64-apple-darwin.zip"
		FTYPE=".zip"
		;;

...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	case "${OS}_${ARCH}" in
	"darwin_arm64")
		URL="https://github.com/ducaale/xh/releases/download/v0.24.1/xh-v0.24.1-aarch64-apple-darwin.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_arm64")
		URL="https://github.com/ducaale/xh/releases/download/v0.24.1/xh-v0.24.1-aarch64-unknown-linux-musl.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_arm")
		URL="https://github.com/ducaale/xh/releases/download/v0.24.1/xh-v0.24.1-arm-unknown-linux-gnueabihf.tar.gz"
		FTYPE=".tar.gz"
		;;
	"darwin_amd64")
		URL="https://github.com/ducaale/xh/releases/download/v0.24.1/xh-v0.24.1-x86_64-apple-darwin.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_amd64")
		URL="https://github.com/ducaale/xh/releases/download/v0.24.1/xh-v0.24.1-x86_64-unknown-linux-musl.tar.gz"
		FTYPE=".tar.gz"
		;;

...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	"linux_arm64")
		...
		;;
	"linux_arm")
		URL="https://github.com/extrawurst/gitui/releases/download/v0.26.3/gitui-linux-arm.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_amd64")
		...
		;;
	"darwin_amd64")
		URL="https://github.com/extrawurst/gitui/releases/download/v0.26.3/gitui-mac-x86.tar.gz"
		FTYPE=".tar.gz"
		;;

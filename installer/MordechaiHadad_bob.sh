...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	case "${OS}_${ARCH}" in
	"linux_arm64")
		URL="https://github.com/MordechaiHadad/bob/releases/download/v2.8.0/bob-linux-aarch64.zip"
		FTYPE=".zip"
		;;
	"linux_amd64")
		URL="https://github.com/MordechaiHadad/bob/releases/download/v2.8.0/bob-linux-x86_64-openssl.zip"
		FTYPE=".zip"
		;;
	"darwin_arm")
		URL="https://github.com/MordechaiHadad/bob/releases/download/v2.8.0/bob-macos-arm-openssl.zip"
		FTYPE=".zip"
		;;
	"darwin_amd64")
		URL="https://github.com/MordechaiHadad/bob/releases/download/v2.8.0/bob-macos-x86_64-openssl.zip"
		FTYPE=".zip"
		;;

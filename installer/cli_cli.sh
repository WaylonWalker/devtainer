...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	case "${OS}_${ARCH}" in
	"linux_386")
		URL="https://github.com/cli/cli/releases/download/v2.49.2/gh_2.49.2_linux_386.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_amd64")
	...
	"linux_arm")
		...
		;;
	"darwin_amd64")
		URL="https://github.com/cli/cli/releases/download/v2.49.2/gh_2.49.2_macOS_amd64.zip"
		FTYPE=".zip"
		;;
	"darwin_arm64")
		URL="https://github.com/cli/cli/releases/download/v2.49.2/gh_2.49.2_macOS_arm64.zip"
		FTYPE=".zip"
		;;

...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	case "${OS}_${ARCH}" in
	"linux_386")
		URL="https://github.com/cli/cli/releases/download/v2.65.0/gh_2.65.0_linux_386.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_amd64")
	...
	"linux_arm64")
		...
		;;
	"linux_arm")
		URL="https://github.com/cli/cli/releases/download/v2.65.0/gh_2.65.0_linux_armv6.tar.gz"
		FTYPE=".tar.gz"
		;;
	"darwin_amd64")

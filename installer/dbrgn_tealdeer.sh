...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	case "${OS}_${ARCH}" in
	"linux_arm")
		URL="https://github.com/dbrgn/tealdeer/releases/download/v1.6.1/tealdeer-linux-arm-musleabi"
		FTYPE=".bin"
		;;
	"linux_amd64")
		URL="https://github.com/dbrgn/tealdeer/releases/download/v1.6.1/tealdeer-linux-i686-musl"
		FTYPE=".bin"
		;;
	"darwin_amd64")
		URL="https://github.com/dbrgn/tealdeer/releases/download/v1.6.1/tealdeer-macos-x86_64"
		FTYPE=".bin"
		;;
